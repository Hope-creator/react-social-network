...
const Registration = (props) => {
    ...
    return props.isAuth ? <Redirect to="/profile" />
        : (<div className={s.loginWrapper}>
            ...
            <RegistationFormWrap captchaUrl={props.captchaUrl} authFailed={props.authFailed} authErrorMessage={props.authErrorMessage} authLoginThunk={props.authLoginThunk} />
